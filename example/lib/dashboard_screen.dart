...
import 'package:login_example/forms/profilepage.dart';
...
class _DashboardScreenState extends State<DashboardScreen>
  ...
  static var balanceValue = double.parse(LoginScreen.balance_taken);
  //var balanceValueUpdate = 0.0;

  var dataValueDashboard = DashboardScreen.data_taken;
...
//top of app bar part
  ...
  Widget _buildHeader(ThemeData theme) {
    ...
    print('dashboard_screen $balanceValue');
  ...
  Widget _buildButton(
    ...
    return RoundButton(
      ...
      onPressed: () async {
        ...
        if (label == "Profile") {
          print('dashboard: idvalue $idValue');

          final url =
              Uri.parse(''); //fetch problem
          var data = {
            "id": idValue,
          };
          ...
          print('dashboard data $dataValueDashboard');

          DashboardScreen.data_taken = dataValueDashboard;
        ...
        if (label == 'Refresh') {
          ...
          balanceValue = double.parse(dataValueDashboard['balance']);

          //Reloader.of(context).reload();
          setState(() {
            print('refresh $dataValueDashboard');
            print(DashboardScreen.data_taken['balance']);
          });
        }
        if (label == 'Payment') {
