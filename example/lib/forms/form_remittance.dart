...
class FormRemittance extends StatefulWidget {
  @override
...
class _FeedbackFormScreenState extends State<FormRemittance> with Validator {
    ...
    return Container(
      ...
      child: RaisedButton(
        onPressed: () async {
          ...
          print('netbill_no value $netbill_no');
